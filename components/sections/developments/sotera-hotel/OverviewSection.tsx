          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-background-secondary p-4 rounded-lg">
                <h4 className="font-semibold text-primary-900 mb-1">Total Rooms</h4>
                <p className="text-primary-600">{specifications.totalRooms}</p>
              </div>
              <div className="bg-background-secondary p-4 rounded-lg">
              ...
              <div className="bg-background-secondary p-4 rounded-lg">
                ...
                <p className="text-primary-600">{specifications.checkIn}</p>
              </div>
              <div className="bg-background-secondary p-4 rounded-lg">
